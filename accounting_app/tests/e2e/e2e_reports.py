...
def test_balance_sheet_page_loads(logged_in_page: Page, flask_server: str):
...
def test_income_statement_page_loads(logged_in_page: Page, flask_server: str):
...
def test_trial_balance_page_loads(logged_in_page: Page, flask_server: str):
...
def test_tax_report_page_loads(logged_in_page: Page, flask_server: str):
