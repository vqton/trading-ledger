...
def test_journal_page_loads(authenticated_page: Page, flask_server: str):
...
def test_journal_create_page_loads(authenticated_page: Page, flask_server: str):
...
def test_journal_has_form_elements(authenticated_page: Page, flask_server: str):
