...
def test_accounts_page_loads(authenticated_page: Page, flask_server: str):
...
def test_account_tree_page_loads(authenticated_page: Page, flask_server: str):
...
def test_accounts_page_has_table(authenticated_page: Page, flask_server: str):
...
def test_ledger_page_loads(authenticated_page: Page, flask_server: str):
